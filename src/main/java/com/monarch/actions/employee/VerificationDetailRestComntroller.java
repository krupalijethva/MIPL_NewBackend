...
public class VerificationDetailRestComntroller {
	...
	@GetMapping("/verificationDetail")
	public void verifyDetails(@RequestParam(value="userid") long userid,@RequestParam(value="userid1") long userid1)
	{
		try
		{
	        ...
	        for(User useremp:userdata)
	        {
	        	  ...
	        	  if (id.equals(userid1))
	        	  {
	                  ...
	                  employee.setVarification(false);
